...
public class Login extends JFrame {
	...
	public Login() {
		...
		JLabel lblNewLabel = new JLabel("Student Name       : Du Mengyu\n");
                ...
                JLabel lblNewLabel4 = new JLabel("Date                     : 05 Sept 2018");
		lblNewLabel.setHorizontalAlignment(SwingConstants.LEFT);
		lblNewLabel.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblNewLabel.setForeground(new Color(240, 248, 255));
		lblNewLabel.setBounds(20, 100, 300, 200);
		...
		lblNewLabel2.setBounds(20, 140, 300, 200);
		...
		lblNewLabel3.setBounds(20, 180, 300, 200);
		...
		lblNewLabel4.setBounds(20, 220, 300, 200);
